...
function transformDataToGameState(data: { history?: unknown[]; players?: unknown[] }): GameState {
  return {
...
function App() {
  ...
  const fetchGame = async () => {
    if (!chatId) {
      setError('No se ha especificado un juego. Añade el ID a la URL (ej: ?id=123456)')
      setLoading(false)
      return
    }
    try {
